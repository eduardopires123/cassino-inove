...
class CheckPermission
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $areas = [
            ...
            "3" => ['admin.sports.sports_apostas', 'admin.sports.apostas.data', 'admin.sports.sports_estatisticas', 'admin.sports.sports_configuracoes', 'admin.sports.campeonatos_ocultos.data', 'admin.sports.categorias_ocultas.data', 'admin.betby-sports.sports_apostas', 'admin.betby-sports.apostas.data', 'admin.betby-sports.apostas.stats', 'admin.betby-sports.apostas.detalhes', 'admin.betby-sports.sports_estatisticas'],
            ...
            "6" => ['admin.administracao.configuracoes_gerais', 'admin.administracao.banco', 'admin.administracao.gateways', 'admin.administracao.apisgames', 'admin.administracao.funcoesepermissoes', 'admin.clear-cache'],
            ...
            "10" => ['admin.lucky-boxes.index', 'admin.lucky-boxes.redemptions.data', 'admin.vip-levels.index', 'admin.vip-levels.redemptions.data', 'admin.coupons.index'],
        ];
