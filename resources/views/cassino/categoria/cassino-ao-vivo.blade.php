    ...
    <section data-v-0a4c896b="" class="spacing"  id="content-game">
        <header class="qMh00">
            <div class="Efcyy">
                ...
                <div class="f22UR">{{ __('casino-live.all_live_casino_games') }}</div>
                <div class="hJNny">
            ...
            <div data-v-959816fa="" class="casino-filters src7V">
                <div data-v-959816fa="" class="casino-search" style="padding: 4px;">
                    <input data-v-959816fa="" class="_6z1L2" id="search-input" placeholder="{{ __('casino-live.search_game') }}" autocomplete="nope" onfocus="this.removeAttribute('readonly');" readonly aria-autocomplete="none">
                </div>
                <div data-v-959816fa="" class="casino-filters__buttons grid grid-cols-2 gap-4">
                    <div data-v-959816fa="" class="listBox-wrapper">
                        <button data-v-959816fa="" id="headlessui-listbox-button-nsiNM9WAguS_1" type="button" aria-haspopup="listbox" aria-expanded="false" data-headlessui-state="" class="select-btn provider-select-btn">
                            {{ __('casino-live.providers') }}: <strong data-v-959816fa="" id="selected-provider">{{ __('casino-live.all') }}</strong>
                        </button>
                        <ul data-v-959816fa="" id="headlessui-listbox-options-nsiNM9WAguS_2" aria-multiselectable="true" aria-labelledby="headlessui-listbox-button-nsiNM9WAguS_1" aria-orientation="vertical" role="listbox" tabindex="0" data-headlessui-state="" class="select-options no-scrollbar provider-options" style="display: none;">
                            <li data-v-959816fa="" id="headlessui-listbox-option-all" role="option" tabindex="-1" aria-selected="true" data-headlessui-state="" class="select-opt">
                                <label data-v-959816fa="" for="all-providers"><input data-v-959816fa="" id="all-providers" name="opt" type="checkbox" value="all" checked /><span data-v-959816fa="" class="ml-2">{{ __('casino-live.all') }}</span></label>
                            </li>
                    ...
                    <div data-v-959816fa="" class="listBox-wrapper">
                        <button data-v-959816fa="" id="headlessui-listbox-button-nsiNM9WAguS_3" type="button" aria-haspopup="listbox" aria-expanded="false" data-headlessui-state="" class="select-btn" disabled>
                            {{ __('casino-live.category') }}: <strong data-v-959816fa="">{{ __('casino-live.live') }}</strong>
                        </button>
                        <!---->
                    </div>
                </div>
        ...
        <div data-v-14a18591="" data-v-0a4c896b="" class="pagination">
            ...
            <span data-v-14a18591="" class="text-texts text-xs mb-4" id="showing-text">{{ __('casino-live.showing') }} {{ $current }} {{ __('casino-live.of') }} {{ $total }} {{ __('casino-live.games') }}</span>
            <button data-v-14a18591="" class="btn-more" id="load-more-btn" data-page="2"><span data-v-14a18591="">{{ __('casino-live.load_more') }}</span></button>
        </div>
    </section>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadProviders() {
                ...
                fetch('/provedores/listar?category=live')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .then(data => {
                        ...
                        fetch('/provedores/verificar-ativos', {
                            ...
                            .then(activeData => {
                                ...
                                if (!activeData.active_providers) {
                                    ...
                                    selectedProviderText.textContent = '{{ __("casino-live.data_error") }}';
                                    return;
                                }
                                ...
                                if (activeProviders.length === 0) {
                                    selectedProviderText.textContent = '{{ __("casino-live.none_active") }}';
                                    return;
                                }
                        ...
                        `;
                                ...
                                selectedProviderText.textContent = '{{ __("casino-live.all") }}';
                                    ...
                                    checkbox.addEventListener('change', function() {
                                        if (this.value === 'all') {
                                            ...
                                            if (checkedProviders.length === 1) {
                                                ...
                                                selectedProviderText.textContent = `${checkedProviders.length} {{ __("casino-live.selected") }}`;
                                            } else {
                            ...
                            .catch(error => {
                                ...
                                selectedProviderText.textContent = '{{ __("casino-live.error") }}';
                    ...
                    .catch(error => {
                        ...
                        selectedProviderText.textContent = '{{ __("casino-live.unavailable") }}';
                    });
            }
            ...
            function resetAndLoadGames() {
                ...
                loadMoreBtn.innerHTML = '<span>{{ __("casino-live.load_more_games") }}</span>';
            ...
            function setupSearchFunctionality() {
                ...
                function processSearch() {
                    ...
                    loadMoreBtn.style.display = 'block';
                    loadMoreBtn.disabled = false;
                    loadMoreBtn.innerHTML = '<span>{{ __("casino-live.load_more") }}</span>';
            ...
            loadMoreBtn.addEventListener('click', function() {
                ...
                loadMoreBtn.innerHTML = '<span>{{ __("casino-live.loading") }}</span>';

                // Usar o caminho relativo correto sem domínio/porta
                let url = `/jogos/carregar-mais?page=${page}&per_page=24&category=live`;
                ...
                fetch(url)
                    ...
                    .then(data => {
                        ...
                        <div class="alert alert-warning"><span>{{ __("casino-live.no_results") }}</span></div>
                    `;
                        ...
                        showingText.textContent = `{{ __("casino-live.showing") }} ${currentShowing} {{ __("casino-live.of") }} ${teste} {{ __("casino-live.games") }}`;
