<div class="nM44t mb-4 md:mb-8">
                <div class="SM-j1">
                    <div class="h9HDs">
                        <h2 data-v-debf714a="" class="title flex items-center justify-center">
                            <p class="">{!! $homeSections->getSectionTitle('custom_title_top_raspadinhas', 'TOP <strong>RASPADINHAS</strong>') !!}</p>
                        </h2>
                    </div>
                    ...
                    <a href="{{ route('raspadinha.index') }}" class="sXdS9">
                ...
                <div class="w-full">
                    <div class="-JVa3 Vulse EEtS9" style="--620ba053: calc((100% - 110px) / 6); --063993a6: 22px; --8ec19218: calc((100% - 110px) / 6); --543ef9ea: 0;" id="mostPlayedRaspadinhasSlider">
                        <div class="rpneC uyA-x H3vO2">
                            @foreach($cachedData['mostPlayedRaspadinhas_cache'] as $index => $raspadinha)
                                <div class="peBY3 Jj-AP swiper-slide">
                                    <a href="JavaScript: void(0);" onclick="openRaspadinha({{ $raspadinha->id }});" class="s3HXA">
                                        <div class="u3Qxq">
                                            <div class="g-hw5">
                                                <img alt="{{ $raspadinha->name }}" class="vTFYb" src="{{ $raspadinha->image_url }}" />
                                                <div class="raspadinha-overlay">
                                                    ...
                                                    @if($raspadinha->plays_count > 0)
                                                        <div class="plays-badge">{{ $raspadinha->plays_count }} jogadas</div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="hzP6t">
