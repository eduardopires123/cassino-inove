<div class="nM44t mb-4 md:mb-8">
                <div class="SM-j1">
                    <div class="h9HDs">
                        <h2 data-v-debf714a="" class="title flex items-center justify-center">
                            <p class="">{!! $homeSections->getSectionTitle('custom_title_new_games', __('menu.new_games')) !!}</p>
                        </h2>
                    </div>
                ...
                <div class="w-full">
                    <div class="-JVa3 Vulse EEtS9" style="--620ba053: calc((100% - 110px) / 6); --063993a6: 22px; --8ec19218: calc((100% - 110px) / 6); --543ef9ea: 0;" id="newGamesSlider">
                        <div class="rpneC uyA-x H3vO2">
                            @foreach($cachedData['recentGames_cache'] as $index => $game)
