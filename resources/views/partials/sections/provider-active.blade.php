<div class="nM44t mb-4 md:mb-8">
                <div class="SM-j1">
                    <div class="h9HDs">
                        <h2 data-v-debf714a="" class="title flex items-center justify-center">
                            <!---->
                            <p class="">{!! $provider->display_name !!}</p>
                        </h2>
                    </div>
                ...
                <span class="inove-icon inove-icon--fill nQro9 cursor-pointer">
                    ...
                    <a href="{{ route('cassino.provider', str_replace(' ', '-', strtolower($provider->name))) }}" class="sXdS9"><span>Ver todos</span><span class="nuxt-icon nuxt-icon--fill"><svg height="1em" viewBox="0 0 320 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                  <path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" fill="currentColor"></path>
                </svg></span></a>
                </div>
                <div data-v-25a087dc="" class="row_imgs" style="margin-bottom: 0;">
                    <div data-v-25a087dc="" class="-JVa3 Vulse EEtS9" style="--620ba053: calc((100% - 110px) / 6); --063993a6: 22px; --8ec19218: calc((100% - 110px) / 6); --543ef9ea: 0;" id="providerSlider{{ $provider->id }}">
                        <div class="rpneC uyA-x H3vO2">
                            @if(isset($providerGames[$provider->id]))
                                @foreach($providerGames[$provider->id] as $game)
