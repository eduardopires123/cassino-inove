            ...
            <div class="relative overflow-hidden">
                ...
                <div class="w-full flex flex-col gap-5 p-6">
                    ...
                    <div class="XRpUl">
                        ...
                        <div class="wK3pT"><span class="Slyxx">{{ __('withdrawal.request_withdrawal') }} - Afiliado</span><span class="PZzYZ" id="pedido"></span></div>
                    ...
                    <div data-v-c09d2d89="" class="step-form">
                        <form data-v-c09d2d89="" class="step-form-item">
                                ...
                                <div data-v-c09d2d89="" class="_6uOXn">
                                    ...
                                    <div data-v-44b1d268="" data-v-c09d2d89="" class="input-group is-disabled px-3" autocomplete="off">
                                        ...
                                        <div data-v-44b1d268="" class="group isCompact placeh" disabled="true" for="minWithdrawAmount" readonly="">
                                            @php
                                                $minSaque = App\Helpers\Core::getSetting()->min_saque_af;
                                            @endphp
                                            <input
                                                data-v-44b1d268=""
                            ...
                            <div data-v-c09d2d89="" class="TvTpT" style="color: #fff;">{{ __('withdrawal.available_for_withdrawal') }}: <strong data-v-c09d2d89="" class="text-primary" id="balance_aff"> {!! 'R$ ' . number_format($user->wallet->refer_rewards, 2, ',', '.') !!}</strong></div>
                            ...
                            <button data-v-c09d2d89="" class="Hzxpd" id="saqueButton" tabindex="1" type="submit" disabled>{{ __('withdrawal.withdraw_button') }}</button>
                        </form>
                    </div>
                </div>
                <!----><!----><!---->
            ...
            <div class="relative overflow-hidden">
                <div class="w-full flex flex-col gap-5 p-6">
                    <div class="XRpUl">
                        ...
                        <div class="wK3pT"><span class="Slyxx">{{ __('withdrawal.withdrawal_success') }} - Afiliado</span><span class="PZzYZ">{{ __('withdrawal.withdraw_balance') }}</span></div>
                    </div>
                    <div class="_967Oa">
                        <div class="-JVa3 -rtCX" style="--620ba053: 0px; --063993a6: 10px; --8ec19218: auto; --543ef9ea: 1;">
                            <div class="rpneC uyA-x H3vO2">
