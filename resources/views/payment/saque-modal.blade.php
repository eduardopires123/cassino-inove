<div class="_8XokL hidden" data-v-owner="374" id="saqueModal">
    <div class="X-T4C sm:max-w-[500px]">
        <button class="pOB1m" id="close-saque-modal">
            <span class="nuxt-icon nuxt-icon--fill">
                <svg height="1em" viewBox="0 0 320 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z" ill="currentColor"></path>
                </svg>
            </span>
        </button>
        <div class="jOkUz">
            <div class="relative overflow-hidden">
                ...
                <div class="w-full flex flex-col gap-5 p-6">
                    ...
                    <div class="XRpUl">
                        ...
                        <div class="wK3pT"><span class="Slyxx">{{ __('withdrawal.request_withdrawal') }}</span><span class="PZzYZ" id="pedido"></span></div>
                    ...
                    <div data-v-c09d2d89="" class="step-form">
                        <form data-v-c09d2d89="" class="step-form-item">
                            <div data-v-c09d2d89="" class="JRYaH">
                                <div data-v-c09d2d89="" class="JRYaH LJmOC">
                                    <div data-v-c09d2d89="" class="_6uOXn">
                                        <label data-v-c09d2d89="" class="EXuwC" for="method">{{ __('withdrawal.payment_method') }}</label>
                                    ...
                                    <div data-v-c09d2d89="" class="_6uOXn">
                                        <label data-v-c09d2d89="" class="EXuwC" for="method">{{ __('withdrawal.minimum_withdrawal') }}</label>
                                        <div data-v-44b1d268="" data-v-c09d2d89="" class="input-group is-disabled px-3" autocomplete="off">
                                            <!----><!---->
                                            <div data-v-44b1d268="" class="group isCompact placeh" disabled="true" for="minWithdrawAmount" readonly="">
                                                @php
                                                    $minSaque = App\Helpers\Core::getSetting()->min_saque_n;
                                                @endphp
                                                <input
                                                    data-v-44b1d268=""
                                ...
                                <label data-v-c09d2d89="" class="QNXby" for="inputCurrency">{{ __('withdrawal.withdrawal_amount') }}:</label>
                                <div data-v-c09d2d89="" class="GdfDk" id="inputCurrency">
                                    <input class="cXaPe _8J-o-" density="compact" placeholder="R$ 0,00" id="amountsaq" type="text" variant="solo" inputmode="numeric" />
                                    <div class="_3qn2o _04yJb _8J-o-">
                            ...
                            <div data-v-c09d2d89="" class="TvTpT" style="color: #fff;">{{ __('withdrawal.available_for_withdrawal') }}: <strong data-v-c09d2d89="" class="text-primary" id="balance_saque">R$ {!! number_format(Auth::user()->Wallet->balance, 2, ',', '.') !!}</strong></div>
                            <div id="no-results-message" class="flex items-center justify-center self-center alert alert-warning" style="margin-bottom: 14px;margin-top: 7px;">
                                <span class="" style="font-size: .75rem;">{{ __('messages.pix_ownership_warning', ['cpf' => '***.' . substr(Auth::user()->pix, 3, 3) . '.' . substr(Auth::user()->pix, 6, 3) . '-**']) }}</span>
                            </div>
                            <button data-v-c09d2d89="" class="Hzxpd" id="saqueButton" tabindex="1" type="submit">{{ __('withdrawal.withdraw_button') }}</button>
                        </form>
                    </div>
                </div>
                <!----><!----><!---->
...
<!-- MODAL DE CONFIRMAÇÃO DO SAQUE -->
<div class="_8XokL hidden" data-v-owner="374" style="--342cf0aa: 450px;" id="confirmacaoSaqueModal">
    <div class="X-T4C sm:max-w-[500px]">
        <button class="pOB1m" id="close-confirmacao-saque">
            <span class="nuxt-icon nuxt-icon--fill">
                <svg height="1em" viewBox="0 0 320 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="relative overflow-hidden">
                <div class="w-full flex flex-col gap-5 p-6">
                    <div class="XRpUl">
                        ...
                        <div class="wK3pT"><span class="Slyxx">{{ __('withdrawal.withdrawal_success') }}</span><span class="PZzYZ">{{ __('withdrawal.withdraw_balance') }}</span></div>
                    </div>
                    <div class="_967Oa">
                        <div class="-JVa3 -rtCX" style="--620ba053: 0px; --063993a6: 10px; --8ec19218: auto; --543ef9ea: 1;">
                            <div class="rpneC uyA-x H3vO2">
                        ...
                        <div class="bg-card-bg rounded-lg p-4 mb-6">
                            <div class="flex flex-col gap-2">
                                <div class="flex justify-between">
                                    <span class="EXuwC">{{ __('withdrawal.amount') }}:</span>
                                    <span class="QNXby font-bold" id="valorSaqueConfirmacao">R$ 0,00</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="EXuwC">{{ __('withdrawal.withdrawal_method') }}:</span>
                                    <span class="QNXby font-bold">PIX</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="EXuwC">{{ __('messages.pix_key') }}:</span>
                                    <span class="QNXby font-bold">CPF: {{ '***.' . substr(Auth::user()->pix, 3, 3) . '.' . substr(Auth::user()->pix, 6, 3) . '-**' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="EXuwC">{{ __('messages.status') }}:</span>
                                    <span class="text-warning font-bold">{{ __('messages.processing') }}</span>
                                </div>
                            </div>
                        </div>
...
<div class="_8XokL hidden" data-v-owner="374" style="--342cf0aa: 450px;" id="BlockSaqueModal">
    <div class="X-T4C sm:max-w-[500px]">
        <button class="pOB1m" id="close-block-saque">
            <span class="nuxt-icon nuxt-icon--fill">
                <svg height="1em" viewBox="0 0 320 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"
                        ...
                        <span class="nuxt-icon nuxt-icon--fill LI8px text-primary">
                            <svg height="1em" viewBox="0 0 512 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                              <path fill="currentColor"
                                    d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm99.3 313.4c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0L256 289.9l-65.4 65.4c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9L222.1 256l-65.4-65.4c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0L256 222.1l65.4-65.4c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9L289.9 256l65.4 65.4z"/>
                            </svg>
                        </span>
                        <div class="wK3pT"><span class="Slyxx">Saque Indisponível</span></div>
                    </div>

                    <div class="step-form">
                        <div class="alert alert-error mb-3 lg:mb-5 mt-0">
                            <div class="processing-container">
                                <svg height="1em" viewBox="0 0 512 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"
                        ...
                        <div class="bg-card-bg rounded-lg p-4 mb-6">
                            <div class="flex flex-col gap-4">
                                <div>
                                    <p class="EXuwC">Prezado usuário,</p>
                                    <p class="EXuwC" style="margin-top: 10px;">
                                        Informamos que, de acordo com a nossa política de prevenção à lavagem de dinheiro,
                                        saques não podem ser realizados imediatamente após o depósito, apenas após a realização de apostas.
                                    </p>
                                    <p class="EXuwC" style="margin-top: 10px;">
                                        Este procedimento é necessário para garantir a segurança de todos os nossos clientes e a integridade de nossas operações.
                                    </p>
                                </div>
                                <div>
                                    <p class="EXuwC">Atenciosamente,</p>
                                    <p class="EXuwC">Equipe {{ App\Helpers\Core::getSetting()->name ?? config('app.name') }}.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<style>
    ...
    /* Styling for the processing container and typing animation */
    ...
    .typing-text::before {
        content: 'O seu saque já está sendo processado...';
    }
