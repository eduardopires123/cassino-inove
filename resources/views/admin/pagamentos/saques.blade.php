        ...
        <div class="page-meta" style="margin-top:45px;">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" id="estatde">Saques</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="widget-content widget-content-area br-8">
                    <div id="zero-config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-saques" class="table table-striped dt-table-hover dataTable" style="width:100%" role="grid" aria-describedby="zero-config_info">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="datatable-saques" rowspan="1" colspan="1">Nome</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-saques" rowspan="1" colspan="1">Valor</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-saques" rowspan="1" colspan="1">Gateway</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-saques" rowspan="1" colspan="1">Status</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-saques" rowspan="1" colspan="1">Data</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<script>
    $(function () {
        ...
        function initDatatable(dataInicial, dataFinal, nomeUsuario) {
            var table = $('#datatable-saques').DataTable({
                processing: false,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: "{{ route('admin.pagamentos.saques.data') }}",
                    data: function (d) {
                ...
                drawCallback: function(settings) {
                    ...
                    $('#datatable-saques_paginate').addClass('paging_simple_numbers');
                    $('#datatable-saques_paginate ul.pagination li').addClass('paginate_button page-item');
                    $('#datatable-saques_paginate ul.pagination li.previous').attr('id', 'datatable-saques_previous');
                    $('#datatable-saques_paginate ul.pagination li.next').attr('id', 'datatable-saques_next');
                    $('#datatable-saques_paginate ul.pagination li.first').attr('id', 'datatable-saques_first');
                    $('#datatable-saques_paginate ul.pagination li.last').attr('id', 'datatable-saques_last');
                    $('#datatable-saques_paginate ul.pagination li a').addClass('page-link');
                    
                    // Substituir o texto dos botões de paginação por ícones SVG
                    $('#datatable-saques_paginate ul.pagination li.first a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-left"><polyline points="11 17 6 12 11 7"></polyline><polyline points="18 17 13 12 18 7"></polyline></svg>');
                    $('#datatable-saques_paginate ul.pagination li.previous a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg>');
                    $('#datatable-saques_paginate ul.pagination li.next a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>');
                ...
                initComplete: function() {
                    ...
                    $('#datatable-saques').on('error.dt', function(e, settings, techNote, message) {
                    });
        ...
        function reloadTable() {
            ...
            $('#datatable-saques').DataTable().destroy();
            ...
            var newUrl = "{{ route('admin.pagamentos.saques') }}?di=" + dataInicial + "&df=" + dataFinal + "&aff=" + encodeURIComponent(nomeUsuario);
    ...
    function gerarRelatorioPDF() {
        ...
        var url = "{{ route('admin.pagamentos.saques.pdf') }}";
        var params = [];
