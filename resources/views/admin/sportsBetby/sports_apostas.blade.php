...
@section('content')
        ...
        <div class="middle-content container-xxl p-0">
            <div class="page-meta" style="margin-top:45px;">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Sportsbook Betby</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="statusFiltro" name="statusFiltro" class="form-control filter-input">
                                                ...
                                                <option value="pending" {{ $statusFiltro == 'pending' ? 'selected' : '' }}>Pendentes</option>
                                                <option value="win" {{ $statusFiltro == 'win' ? 'selected' : '' }}>Ganhos</option>
                                                <option value="lost" {{ $statusFiltro == 'lost' ? 'selected' : '' }}>Perdidos</option>
                                                <option value="debit" {{ $statusFiltro == 'debit' ? 'selected' : '' }}>Apostas</option>
                                                <option value="credit" {{ $statusFiltro == 'credit' ? 'selected' : '' }}>Pagos</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="datatable-apostas" class="table table-striped dt-table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-config_info">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">Odds</th>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="card border-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <p><strong>Provedor:</strong> <span id="providerName">Betby</span></p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><strong>Cashout:</strong> <span id="hasCashout"></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Nova seção para histórico de operações do transactionId -->
                    <div class="row mt-3 mb-3">
                        <div class="col-md-12">
                            <button class="btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#operationHistory" aria-expanded="false" aria-controls="operationHistory">
                                Histórico de Operações
                            </button>
                            <div class="collapse mt-3" id="operationHistory">
                                <div class="card card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="operacoesTable">
                                            <thead>
                                                <tr>
                                                    <th>Operação</th>
                                                    <th>Valor</th>
                                            ...
                                            <tbody id="operationHistoryBody">
                                                <!-- O histórico de operações será inserido aqui -->
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong>Esporte:</strong> <span id="sportName"></span></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card border-0 mb-3">
                                ...
                                <div class="card-body">
                                    <p><strong></strong> <span id="factor"></span></p>
                                    <p><strong>Time/Resultado apostado:</strong> <span id="stakeName"></span></p>
                                    <p><strong>Mercado:</strong> <span id="marketName"></span></p>
                    ...
                    <!-- JSON do betslip (oculto por padrão) -->
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <button class="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#rawBetslip" aria-expanded="false" aria-controls="rawBetslip">
                                Mostrar JSON Completo
                            </button>
                            <div class="collapse mt-3" id="rawBetslip">
                                <div class="card card-body">
                                    <pre id="betslip-content" style="max-height: 300px; overflow-y: auto;"></pre>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @push('scripts')
        <!-- Inclui apenas o script de visualização de apostas Betby -->
        <script src="{{ asset('js/betby-bet-view.js') }}"></script>
        <script>
            $(function () {
                ...
                function initDatatable(dataInicial, dataFinal, nomeUsuario, statusFiltro) {
                    ...
                    var table = $('#datatable-apostas').DataTable({
                        ...
                        ajax: {
                            dataSrc: 'data',
                            url: "{{ route('admin.betby-sports.apostas.data') }}",
                            data: function (d) {
                        ...
                        drawCallback: function(settings) {
                            ...
                            // Após desenhar a tabela, re-inicializar os botões "Ver Aposta" da Betby
                            if (typeof window.betbyBetModal !== 'undefined' && window.betbyBetModal.setupBetViewButtons) {
                                window.betbyBetModal.setupBetViewButtons();
                            } else if (typeof window.initBetViewButtons === 'function') {
                                window.initBetViewButtons();
                            }
                        },
                ...
                function reloadTable() {
                    ...
                    var newUrl = "{{ route('admin.betby-sports.sports_apostas') }}?di=" + dataInicial + "&df=" + dataFinal + "&aff=" + encodeURIComponent(nomeUsuario) + "&statusFiltro=" + encodeURIComponent(statusFiltro);
                ...
                function loadStats() {
                    ...
                    $.ajax({
                        url: "{{ route('admin.betby-sports.apostas.stats') }}",
                        type: 'GET',
                        data: {
