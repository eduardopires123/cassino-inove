                ...
                <div class="widget-content widget-content-area br-8">
                    <div id="invoice-list_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-carteiras" class="table table-striped dt-table-hover dataTable" style="width:100%" role="grid" aria-describedby="zero-config_info">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Nome</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Saldo</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Saldo Bônus</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Saldo Referidos</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Última Movimentação</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-carteiras" rowspan="1" colspan="1">Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">Saldo Bônus</th>
                                        <th rowspan="1" colspan="1">Saldo Referidos</th>
                                        <th rowspan="1" colspan="1">Última Movimentação</th>
...
<script>
    $(function () {
        ...
        function initDatatable(dataInicial, dataFinal, nomeUsuario) {
            var table = $('#datatable-carteiras').DataTable({
                processing: false,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: "{{ route('admin.usuarios.carteiras.data') }}",
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'saldo_bonus', name: 'saldo_bonus'},
                    {data: 'saldo_referidos', name: 'saldo_referidos'},
                    {data: 'ultima_movimentacao', name: 'ultima_movimentacao'},
                ...
                order: [[1, 'desc']], // Ordenar por saldo (decrescente)
                ...
                drawCallback: function(settings) {
                    ...
                    $('#datatable-carteiras_paginate').addClass('paging_simple_numbers');
                    $('#datatable-carteiras_paginate ul.pagination li').addClass('paginate_button page-item');
                    $('#datatable-carteiras_paginate ul.pagination li.previous').attr('id', 'datatable-carteiras_previous');
                    $('#datatable-carteiras_paginate ul.pagination li.next').attr('id', 'datatable-carteiras_next');
                    $('#datatable-carteiras_paginate ul.pagination li.first').attr('id', 'datatable-carteiras_first');
                    $('#datatable-carteiras_paginate ul.pagination li.last').attr('id', 'datatable-carteiras_last');
                    $('#datatable-carteiras_paginate ul.pagination li a').addClass('page-link');
                    
                    // Substituir o texto dos botões de paginação por ícones SVG
                    $('#datatable-carteiras_paginate ul.pagination li.first a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-left"><polyline points="11 17 6 12 11 7"></polyline><polyline points="18 17 13 12 18 7"></polyline></svg>');
                    $('#datatable-carteiras_paginate ul.pagination li.previous a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg>');
                    $('#datatable-carteiras_paginate ul.pagination li.next a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>');
                    $('#datatable-carteiras_paginate ul.pagination li.last a').html('<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>');
                },
                initComplete: function() {
                    // Adiciona um evento para recarregar a tabela quando ocorrer um erro
                    $('#datatable-carteiras').on('error.dt', function(e, settings, techNote, message) {
                    });
        ...
        function reloadTable() {
            ...
            $('#datatable-carteiras').DataTable().destroy();
            ...
            var newUrl = "{{ route('admin.usuarios.carteiras') }}";
            var hasParams = false;
