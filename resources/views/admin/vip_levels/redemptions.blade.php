        ...
        <div class="page-meta" style="margin-top:45px;">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Resgates - {{ $vipLevel->name }}</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div id="invoice-list_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 d-flex align-items-end">
                                        <a href="{{ route('admin.vip-levels.index') }}" class="btn btn-secondary w-100">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-redemptions" class="table table-striped dt-table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-config_info">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="datatable-redemptions" rowspan="1" colspan="1" style="width: 80px">ID</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-redemptions" rowspan="1" colspan="1">Coins</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-redemptions" rowspan="1" colspan="1">Rodadas Grátis</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-redemptions" rowspan="1" colspan="1">Saldo Real</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-redemptions" rowspan="1" colspan="1">Saldo Bônus</th>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">Coins</th>
                                        <th rowspan="1" colspan="1">Rodadas Grátis</th>
                                        <th rowspan="1" colspan="1">Saldo Real</th>
    ...
    $(function() {
        ...
        function initDatatable(start_date, end_date, search, type) {
            var table = $('#datatable-redemptions').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('admin.vip-levels.redemptions.data', $vipLevel->id) }}",
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'free_spins', name: 'free_spins'},
                    {data: 'balance', name: 'balance'},
                    {data: 'balance_bonus', name: 'balance_bonus'},
        ...
        function reloadTable() {
            ...
            var newUrl = "{{ route('admin.vip-levels.redemptions', $vipLevel->id) }}";
            var hasParams = false;
